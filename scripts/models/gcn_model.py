...
from torch_geometric.nn import GraphConv , EdgeCNN
...
class GNNL(torch.nn.Module):
    def __init__(self, hidden_channels, n_features):
        ...
        self.conv_node_1 = GraphConv(n_features, hidden_channels, dropout=0.4)
        self.conv_node_2 = GraphConv(hidden_channels, hidden_channels, dropout=0.4)
        self.conv_node_3 = GraphConv(hidden_channels, hidden_channels, dropout=0.4)
        
        self.lin1 = Linear(hidden_channels * 2, int(hidden_channels / 2))
